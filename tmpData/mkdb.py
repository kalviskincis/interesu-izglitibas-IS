...
c.execute('CREATE TABLE IF NOT EXISTS pulcini (joma TEXT, maxAudzekni INTEGER, nosaukums TEXT, pulcID INTEGER PRIMARY KEY, iicID INTEGER, stunduSkaits INTEGER, vecumslidz INTEGER, vecumsno INTEGER)')
pulc_json = json.load(open('tmpData/pulcTabula.json'))
pulc_kolonnas = ['joma', 'maxAudzekni', 'nosaukums', 'pulcID', 'iicID', 'stunduSkaits', 'vecumslidz', 'vecumsno']
